---
title: "РћРґРЅР° РїСЂСЏРјР°СЏ: СЂР°СЃСЃС‚РѕСЏРЅРёРµ РІРѕСЃСЃС‚Р°РЅРѕРІР»РµРЅРЅРѕР№ РїСЂСЏРјРѕР№ РґРѕ РёСЃС‚РёРЅРЅРѕР№"
author: "Alex"
date: "2026-04-12"
output:
  html_document:
...
Р—Р°РіСЂСѓР¶Р°РµРј С‚Рµ Р¶Рµ РёСЃС‚РѕС‡РЅРёРєРё Рё Р±РёР±Р»РёРѕС‚РµРєРё, РєРѕС‚РѕСЂС‹Рµ РёСЃРїРѕР»СЊР·СѓСЋС‚СЃСЏ РІ СЌРєСЃРїРµСЂРёРјРµРЅС‚Р°С… СЃ РѕРґРЅРѕР№ РїСЂСЏРјРѕР№.
...
РќРёР¶Рµ РЅР°С…РѕРґСЏС‚СЃСЏ С„СѓРЅРєС†РёРё РїСЂРµРґРѕР±СЂР°Р±РѕС‚РєРё Рё С„СѓРЅРєС†РёРё РґР»СЏ РїРѕСЃС‚СЂРѕРµРЅРёСЏ С‚Р°Р±Р»РёС†. РћРЅРё РїРѕРІС‚РѕСЂСЏСЋС‚ Р»РѕРіРёРєСѓ `line_experiment3.Rmd`.
```{r helpers}
clip01 <- function(m) {
  m <- as.matrix(m)
  m[!is.finite(m)] <- 0
...
Р—Р°РґР°РµРј РєРѕРЅС„РёРіСѓСЂР°С†РёРё РїСЂСЏРјС‹С…, С‡РёСЃР»Рѕ РїРѕРІС‚РѕСЂРѕРІ Рё РїР°СЂР°РјРµС‚СЂС‹ РїСЂРµРѕР±СЂР°Р·РѕРІР°РЅРёСЏ РҐР°С„Р°. РџРѕ СѓРјРѕР»С‡Р°РЅРёСЋ СЃС‡РёС‚Р°РµС‚СЃСЏ 100 РїРѕРІС‚РѕСЂРѕРІ; РґР»СЏ РєРѕСЂРѕС‚РєРѕР№ РїСЂРѕРІРµСЂРєРё РјРѕР¶РЅРѕ Р·Р°РїСѓСЃРєР°С‚СЊ СЃ РїРµСЂРµРјРµРЅРЅРѕР№ РѕРєСЂСѓР¶РµРЅРёСЏ `LINE_DISTANCE_N_REP=1`.
...
Р¤РѕСЂРјРёСЂСѓРµРј СЃРїРёСЃРѕРє РґРµС‚РµРєС‚РѕСЂРѕРІ. Р•СЃР»Рё `bm3d` РЅРµ СѓСЃС‚Р°РЅРѕРІР»РµРЅ РІ С‚РµРєСѓС‰РµРј Python-РѕРєСЂСѓР¶РµРЅРёРё, СЌС‚РѕС‚ РјРµС‚РѕРґ Р±СѓРґРµС‚ РїСЂРѕРїСѓС‰РµРЅ.
```{r detector-list}
detectors <- list(
...
Р’ СЌС‚РѕРј СЌРєСЃРїРµСЂРёРјРµРЅС‚Рµ РјРµС‚СЂРёРєР° СЃС‡РёС‚Р°РµС‚СЃСЏ РЅРµ РїРѕ СЂР°Р·РЅРѕСЃС‚Рё РїР°СЂР°РјРµС‚СЂРѕРІ, Р° РїРѕ РІРѕСЃСЃС‚Р°РЅРѕРІР»РµРЅРЅРѕР№ РїСЂСЏРјРѕР№. РЎРЅР°С‡Р°Р»Р° РЅР°С…РѕРґРёРј РјР°РєСЃРёРјСѓРј Р°РєРєСѓРјСѓР»СЏС‚РѕСЂР°, Р·Р°С‚РµРј СЃС‚СЂРѕРёРј РїСЂСЏРјСѓСЋ РїРѕ РЅР°Р№РґРµРЅРЅС‹Рј `rho, theta`, РїРѕСЃР»Рµ С‡РµРіРѕ СѓСЃСЂРµРґРЅСЏРµРј СЂР°СЃСЃС‚РѕСЏРЅРёСЏ РµРµ РЅРµРЅСѓР»РµРІС‹С… РїРёРєСЃРµР»РµР№ РґРѕ РёСЃС‚РёРЅРЅРѕР№ РїСЂСЏРјРѕР№.
```{r experiment-function}
...
Р—Р°РїСѓСЃРєР°РµРј СЂР°СЃС‡РµС‚ РёР»Рё С‡РёС‚Р°РµРј СѓР¶Рµ СЃРѕС…СЂР°РЅРµРЅРЅС‹Рµ СЂРµР·СѓР»СЊС‚Р°С‚С‹, РµСЃР»Рё С„Р°Р№Р» СЃРѕРѕС‚РІРµС‚СЃС‚РІСѓРµС‚ С‚РµРєСѓС‰РёРј РїР°СЂР°РјРµС‚СЂР°Рј СЌРєСЃРїРµСЂРёРјРµРЅС‚Р°. РџРѕ СѓРјРѕР»С‡Р°РЅРёСЋ СЃРЅР°С‡Р°Р»Р° РїСЂРѕР±СѓРµРј Р±С‹СЃС‚СЂС‹Р№ РїСѓС‚СЊ: РІР·СЏС‚СЊ СѓР¶Рµ РЅР°Р№РґРµРЅРЅС‹Рµ РїР°СЂР°РјРµС‚СЂС‹ РёР· `line_experiment3` Рё РїРµСЂРµСЃС‡РёС‚Р°С‚СЊ С‚РѕР»СЊРєРѕ СЂР°СЃСЃС‚РѕСЏРЅРёСЏ РІРѕСЃСЃС‚Р°РЅРѕРІР»РµРЅРЅС‹С… РїСЂСЏРјС‹С….
```{r run-experiment}
...
РђРіСЂРµРіРёСЂСѓРµРј РјРµС‚СЂРёРєСѓ: СЃСЂРµРґРЅРµРµ Рё РјРµРґРёР°РЅР° СЃС‡РёС‚Р°СЋС‚СЃСЏ РїРѕ СЃСЂРµРґРЅРёРј СЂР°СЃСЃС‚РѕСЏРЅРёСЏРј РґР»СЏ РѕС‚РґРµР»СЊРЅС‹С… РІРѕСЃСЃС‚Р°РЅРѕРІР»РµРЅРЅС‹С… РїСЂСЏРјС‹С…, Р° `point_weighted_mean_distance` РґРѕРїРѕР»РЅРёС‚РµР»СЊРЅРѕ СѓСЃСЂРµРґРЅСЏРµС‚ РїРѕ РІСЃРµРј РїРёРєСЃРµР»СЏРј РІРѕСЃСЃС‚Р°РЅРѕРІР»РµРЅРЅС‹С… РїСЂСЏРјС‹С….
```{r summary}
...
Р’С‹РІРѕРґРёРј С‚Р°Р±Р»РёС†С‹ СЃСЂРµРґРЅРёС… СЂР°СЃСЃС‚РѕСЏРЅРёР№ Рё РЅРѕСЂРјРёСЂРѕРІР°РЅРЅС‹Рµ РІРµСЂСЃРёРё РѕС‚РґРµР»СЊРЅРѕ РґР»СЏ РєР°Р¶РґРѕРіРѕ СѓСЂРѕРІРЅСЏ С€СѓРјР°: РІ РєР°Р¶РґРѕР№ СЃС‚СЂРѕРєРµ РєРѕРЅС„РёРіСѓСЂР°С†РёРё Р·РЅР°С‡РµРЅРёРµ РґРµР»РёС‚СЃСЏ РЅР° Р»СѓС‡С€РёР№ СЂРµР·СѓР»СЊС‚Р°С‚ РґР»СЏ СЌС‚РѕР№ РєРѕРЅС„РёРіСѓСЂР°С†РёРё.
```{r xtabs-mean-distance}
...
РћС‚РґРµР»СЊРЅРѕ РІС‹РІРѕРґРёРј РјРµРґРёР°РЅРЅС‹Рµ СЂР°СЃСЃС‚РѕСЏРЅРёСЏ Рё РёС… РЅРѕСЂРјРёСЂРѕРІР°РЅРЅС‹Рµ РІРµСЂСЃРёРё РґР»СЏ РєР°Р¶РґРѕРіРѕ СѓСЂРѕРІРЅСЏ С€СѓРјР°.
```{r xtabs-median-distance}
...
РЎРѕС…СЂР°РЅСЏРµРј СЃС‹СЂС‹Рµ СЂРµР·СѓР»СЊС‚Р°С‚С‹, СЃРІРѕРґРєСѓ Рё TeX-С‚Р°Р±Р»РёС†С‹ РІ РїР°РїРєСѓ `tables` РІРЅСѓС‚СЂРё `VKR_SLIDES`.
```{r save-tables}
slides_tables_dir <- file.path("..", "VKR", "VKR_SLIDES", "tables")
